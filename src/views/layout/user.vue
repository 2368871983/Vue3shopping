<template>
  <div class="user">
    ...
    <div class="order-navbar">
      <div class="order-navbar-item" @click="isLogin?$router.push('/myorder?dataType=all'):$router.push('/login')">
        <van-icon name="balance-list-o" />
        <span>全部订单</span>
      </div>
      <div class="order-navbar-item" @click="isLogin ? $router.push('/myorder?dataType=payment') : $router.push('/login')">
        <van-icon name="clock-o" />
        <span>待支付</span>
      </div>
      <div class="order-navbar-item" @click="isLogin ?$router.push('/myorder?dataType=delivery'): $router.push('/login')">
        <van-icon name="logistics" />
        <span>待发货</span>
      </div>
      <div class="order-navbar-item" @click="isLogin ?$router.push('/myorder?dataType=received'): $router.push('/login')">
